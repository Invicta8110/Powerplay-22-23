package org.firstinspires.ftc.sampleCode.Hardware;
...
public class SmartLynxModule {
    ...
    // the LynxModule is just the object type for control/expansion hubs (like DcMotorEx is for motors)

    //TODO: integrate into code so config name can just be replaced with port numbers
