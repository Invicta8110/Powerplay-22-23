...
public class RoadRunner_Example_Auton_Control {
    ...
    public RoadRunner_Example_Auton_Control(String flName, String frName, String brName, String blName, HardwareMap hardwareMap, Telemetry telemetry){
