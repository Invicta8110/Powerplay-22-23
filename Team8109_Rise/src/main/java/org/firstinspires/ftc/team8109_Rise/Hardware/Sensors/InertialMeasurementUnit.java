package org.firstinspires.ftc.team8109_Rise.Hardware.Sensors;
...
public class InertialMeasurementUnit {
    ...
    public InertialMeasurementUnit(HardwareMap hardwareMap){
        ...
        straight = imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.RADIANS);
    }
