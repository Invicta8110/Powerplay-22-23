    ...
    public void SlidesControl(){
        switch (SlideState){
            case IDLE:
                ...
                break;
            case HOME:
                drawerSlides.slidesMotor.setPower(slidesPID.PIDF_Power(drawerSlides.getHeight(), 0, drawerSlides.maxHeight));
                ...
                break;
            case FIVE_INCHES:
                drawerSlides.slidesMotor.setPower(slidesPID.PIDF_Power(drawerSlides.getHeight(), 5, drawerSlides.maxHeight));
            ...
            case TEN_INCHES:
                drawerSlides.slidesMotor.setPower(slidesPID.PIDF_Power(drawerSlides.getHeight(), 10, drawerSlides.maxHeight));
