...
//@Autonomous
public class CycleAuton_PID_Real_Legit_TwentyPark  extends LinearOpMode {
            ...
            case CYCLE:
                switch (cycleState){
                    ...
                    case WAIT_ONE:
                        ...
                        break;
                    case TO_CONE_STACK:
                        targetPose.set(50.3, 26.3, -1.6166); //50.3
                    ...
                    case BOOST_UP:
                        ...
                        if (runtime.seconds() > 0.75) {
                            cycleState = CycleAuton_PID_Real_Legit_Twenty.CycleState.MOVE_OUT;
                            runtime.reset();
                            tolerance = 0.25;
                        }
                        break;
...
//                        targetPose.set(53, -2, -0.959);
                        ...
                        if (targetPose.findDistance(chassis.getPoseVector()) < tolerance){
                            cycleState = CycleAuton_PID_Real_Legit_Twenty.CycleState.WAIT_TWO;
                            runtime.reset();
                            tolerance = 1;
                        }
                        break;
