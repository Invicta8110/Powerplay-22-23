...
//@Autonomous
public class CycleAuton_PID_Best_Real_Legit_TwentyPark_Actual extends LinearOpMode {
    ...
    public void autonLeftRed(){
        switch (autonState){
            case PUSH_CONE:
                ...
                if (targetPose.findDistance(chassis.getPoseVector()) < translationalTolerance){
