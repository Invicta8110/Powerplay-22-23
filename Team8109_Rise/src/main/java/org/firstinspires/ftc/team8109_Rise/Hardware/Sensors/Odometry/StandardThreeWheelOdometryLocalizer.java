package org.firstinspires.ftc.team8109_Rise.Hardware.Sensors.Odometry;
...
public abstract class StandardThreeWheelOdometryLocalizer extends ThreeTrackingWheelLocalizer {
    /*
    ...
    public StandardThreeWheelOdometryLocalizer(int[] DriveConstants, String[] configNames, HardwareMap hardwareMap) {
        super(Arrays.asList(
        ...
        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, configNames[3]));
