...
public class Ri3D_DR4B_Test_Control {
    ...
    public Ri3D_DR4B_Test_Control(String BarMotorName, Telemetry telemetry, Gamepad gamepad1, HardwareMap hardwareMap){
        DR4B = new DoubleReverse4Bar(BarMotorName, 1, hardwareMap);
    ...
    public void DoubleReverse4Bar_Motion(){
        switch (BarState){
            case INTAKE:
                power = BarPID.PIDF_Power(DR4B.barMotor.getCurrPosDegrees(), 0, 5000);
            ...
            case SCORE_HIGH:
                power = BarPID.PIDF_Power(DR4B.barMotor.getCurrPosDegrees(), -110, 110);
                DR4B.barMotor.setPower(power);
