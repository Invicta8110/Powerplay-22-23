...
@Autonomous
public class No_cameraCycleAuton_PID_Real_Legit_TwentyPark_Actual extends LinearOpMode {
...
//                            cycleState = CycleAuton_PID_Real_Legit_Twenty.CycleState.TO_CONE_STACK;
                    ...
                    case BOOST_UP:
                        ...
                        if (runtime.seconds() > 0.75) {
                            chassis.TranslationalPID_X.setPIDCoefficents(0.15, 0.03, 0, 0);//0.03 0.001
                            chassis.TranslationalPID_Y.setPIDCoefficents(0.15, 0.03, 0, 0);
                            chassis.HeadingPID.setPIDCoefficents(2.5, 0.03, 0.2, 0.002);

                            cycleState = CycleState.MOVE_OUT;
                            translationalTolerance = 7;
                            runtime.reset();
                        }
                        break;
                    case MOVE_OUT:
//                        targetPose.set(50.3, 10, -1.609);
                        targetPose.set(50, 2, -1.606);
//                        targetPose.set(53, -2, -0.959);
                        ...
                        if (withinPoseTolerance()){
                            ...
                            chassis.TranslationalPID_X.setPIDCoefficents(0.4, 0.04, 0, 0.002);//0.03 0.001
                            chassis.TranslationalPID_Y.setPIDCoefficents(0.4, 0.04, 0, 0.003);
                            chassis.HeadingPID.setPIDCoefficents(2, 0.04, 0, 0.001); // 0.03 0.1 0.001
